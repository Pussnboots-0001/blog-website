...
mongoose.connect("mongodb+srv://vid_019:zISrNFnp68fWXp79@cluster0.plq4p1b.mongodb.net/?retryWrites=true&w=majority").then(() => {
...
app.listen(port, () => { console.log('Server is running at port 5500') });